...
<%  int i=1;
    ...
    try{
        for(;i<=sum;i++)
        {
                ...
                List<title> list=sqlSession.selectList("test.selectall",h+"2");
                if(mo==null&&hu==null)
                {
                    for(title u:list)
                    {
                        ...
                        load l=new load();
                        l.setImage(m);
                        l.setHtml("/hello5?name="+h+"&from=2&id="+u.getId());
                        aa.add(u);
                    }
                }
                else
...
<div class="rg_layout">
    ...
    <table id="dg" title="招领查询" style="width:700px;height:300px" data-options="
                rownumbers:true,
                singleSelect:true,
                autoRowHeight:false,
                pagination:true,
...
" align="center">
        ...
        <tr>
            ...
            <th field="date" width="140">拾到物品</th>
            <th field="name" width="120">拾到所在地点</th>
            <th field="amount" width="130" align="right">拾到日期</th>
    ...
    <script type="text/javascript">
        function rowformater(value, row, index) {
            return "<a href='/hello5?name=" + row.inv+"&from=2&id="+row.id + "' >" + row.inv + "</a>";
        }
    </script>
